# Suto Back side(best side)
[![forthebadge](https://forthebadge.com/images/badges/built-with-love.svg)](https://forthebadge.com)

Principalement Développé en [JS](https://developer.mozilla.org/fr/docs/Web/JavaScript) avec [node.js](https://nodejs.org/en/) ce [projet](https://eager-brahmagupta-148328.netlify.app/) est réalisé sous la tutelle de [fueledbycoffe](https://github.com/fueledbycoffee) accompagné de mon camarade calvin LY et fût un des plus instructifs,excitant et intensif de ma scolarité avec une semaine pour réaliser le projet avec une nouvelle tedchnologie.
